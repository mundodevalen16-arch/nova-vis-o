...
const Hero = () => {
  ...
  return (
    <section ref={ref} className="relative min-h-[140vh] px-4 py-8 md:py-12 pt-8" style={{ perspective: "1500px" }}>
      ...
      <div className="sticky top-0 min-h-screen flex items-center justify-center">
        ...
        >
          ...
          {/* Inner content */}
          <div className="relative z-10 px-8 md:px-16 pt-8 pb-10 min-h-[50vh] flex flex-col justify-between">
            {/* Logo */}
            <div className="mb-12">
