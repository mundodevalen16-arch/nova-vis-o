    ...
    <section ref={ref} className="py-10 md:py-20 px-6 relative overflow-hidden" style={{ perspective: "1500px" }}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          {/* Name — graffiti style matching explosion signature */}
          <motion.h3
            style={{ 
              scale: nameScale, 
              opacity: nameOpacity,
              ...
              WebkitTextStroke: "2px hsl(260 100% 20% / 0.9)",
            }}
            className="text-6xl md:text-8xl font-black mb-2 relative [filter:drop-shadow(0_0_40px_hsl(280_100%_50%/0.7))_drop-shadow(0_0_80px_hsl(300_100%_50%/0.4))_drop-shadow(0_0_24px_hsl(300_100%_50%/0.6))]"
          >
            iBielZz
          </motion.h3>
